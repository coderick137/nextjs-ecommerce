...
async function main() {
  const products = [
    ...
    },
    {
      ...
      image_url:
        'https://images.unsplash.com/photo-1551107696-a4b0c5a0d9a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2Nob29sfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
      category: 'srteetwear',
      price_in_cents: 19900,
      sales: 101,
      created_at: new Date(),
